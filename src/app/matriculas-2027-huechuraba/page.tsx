...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "Escuela gratuita en Conchalí, a minutos de Huechuraba, con evaluación fonoaudiológica sin costo.",
    images: ["/og-image.jpg"],
  },
};
  ...
  return (
    <>
      ...
      <div className="pt-28 overflow-hidden bg-paper">
        <PageHero
          eyebrow="Cupos 2027 cerca de Huechuraba"
          eyebrowIcon={ShieldCheck}
          title="Matrícula en escuela de lenguaje cerca de Huechuraba"
          lead="A minutos de Huechuraba, con 2 sedes en Conchalí (Vascongados 4314 y Gral. Gambino 4613). Consulta cupo 2027 con evaluación fonoaudiológica sin costo para niños y niñas con TEL."
          decoration={
            <>
              <Image
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 items-center">
            <div>
              ...
              <p className="text-lg text-muted leading-relaxed mb-8">
                Sabemos que muchas familias de Huechuraba no tienen claro si
