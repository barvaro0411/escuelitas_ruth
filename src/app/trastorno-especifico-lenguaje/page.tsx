...
const telFacts = [
  ...
  },
  {
    ...
    value: "9 de 10",
    color: "bg-secondary text-primary-dark",
  },
];
...
export default function TrastornoEspecificoLenguajePage() {
  const breadcrumbsJsonLd = buildBreadcrumbsJsonLd([
    { name: "Inicio", url: "/" },
    { name: "Trastorno Específico del Lenguaje (TEL)", url: "/trastorno-especifico-lenguaje" },
  ]);
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] flex items-center bg-primary-dark text-white">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary-dark via-primary-dark/95 to-primary/60" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
          <div className="max-w-3xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-secondary text-primary-dark text-xs font-black uppercase tracking-widest mb-7 shadow-xl">
            ...
            <p className="text-xl sm:text-2xl text-white/90 font-bold leading-snug max-w-2xl mb-10">
              El TEL es un trastorno del desarrollo del lenguaje que afecta la
              capacidad de un niño para comprender y expresarse oralmente, sin
              que exista una causa intelectual, auditiva o neurológica que lo
              explique.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/admision"
                className="inline-flex items-center justify-center px-8 py-5 rounded-2xl bg-white/10 border border-white/20 text-white font-black text-lg hover:bg-white/20 transition-colors"
              >
                Ver requisitos
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {telFacts.map((fact) => (
              ...
              >
                <span className={`px-4 py-2 rounded-xl font-black text-2xl ${fact.color} shadow`}>
                  {fact.value}
                </span>
                <p className="font-bold text-white/85 leading-snug text-sm">
                  {fact.label}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-accent text-primary-dark text-xs font-black uppercase tracking-widest mb-4 shadow-sm">
              <AlertCircle className="mr-1.5 h-3.5 w-3.5" />
              Señales de alerta
            </span>
            <h2 className="text-4xl sm:text-5xl font-black text-foreground tracking-tight leading-[1.1] mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {warningSigns.map((sign) => (
              <div
                key={sign.title}
                className="rounded-2xl border border-border bg-background p-6 shadow-sm hover:shadow-md transition-shadow group"
              >
                ...
                <p className="text-sm text-foreground/65 font-semibold leading-relaxed">
                  {sign.description}
                </p>
              </div>
            ))}
          ...
          <div className="mt-10 max-w-3xl mx-auto p-6 rounded-2xl bg-secondary/20 border border-secondary/40 flex items-start gap-4">
            <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
            <p className="text-foreground/80 font-bold leading-relaxed">
              <strong>¿Reconoces alguna de estas señales?</strong> No esperes a
              que tu hijo &quot;lo supere solo&quot;. La intervención temprana en etapa
              preescolar tiene los mejores resultados. Podemos orientarte sin
              costo.
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-background border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-foreground/75 font-semibold leading-relaxed text-lg">
              <p>
                El <strong className="text-foreground">Trastorno Específico del Lenguaje (TEL)</strong> es
                una dificultad significativa en la adquisición y el uso del
                lenguaje oral, que no se explica por pérdida auditiva,
                discapacidad intelectual, alteración neurológica ni falta de
                estimulación.
              </p>
              <p>
                Afecta tanto la <strong className="text-foreground">comprensión</strong> (entender lo
                que le dicen) como la <strong className="text-foreground">expresión</strong> (construir
                frases, encontrar palabras, pronunciar correctamente). En
                algunos niños predomina una u otra área.
              </p>
              <p>
                El TEL <strong className="text-foreground">no es lo mismo que el autismo</strong> ni
                que una discapacidad intelectual. El niño aprende, juega y se
                relaciona con normalidad: su dificultad está específicamente en
                el lenguaje oral.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="font-black text-foreground mb-1 text-base">
                    {card.title}
                  </h3>
      ...
      <section className="py-24 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-white/15 border border-white/20 text-white text-xs font-black uppercase tracking-widest mb-4">
            ...
            <p className="text-lg text-white/80 font-semibold leading-relaxed">
              ...
              establecimiento especializado que combina educación parvularia con
              intervención fonoaudiológica diaria, diseñado específicamente para
              niños con TEL.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {schoolFeatures.map((feature) => (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-secondary text-primary-dark flex items-center justify-center mb-5">
                  <feature.icon className="h-6 w-6" />
                </div>
                <h3 className="text-xl font-black text-white mb-3 leading-tight">
                  {feature.title}
                </h3>
                <p className="text-white/75 font-semibold leading-relaxed text-sm">
                  {feature.description}
                </p>
              </div>
            ))}
      ...
      <section className="py-24 bg-background border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-14 items-center">
          <div>
            <span className="inline-block px-4 py-2 rounded-full bg-secondary text-primary-dark font-black uppercase tracking-widest text-xs mb-5 shadow-sm">
            ...
            <p className="text-lg text-foreground/70 font-semibold leading-relaxed mb-8">
              ...
              <strong className="text-foreground">3 a 5 años 11 meses</strong>{" "}
              con TEL u orientación de evaluación fonoaudiológica. El acceso es{" "}
              <strong className="text-foreground">gratuito</strong>, sin mensualidad ni matrícula.
            </p>
            ...
            <ul className="space-y-4 mb-9">
              {requirements.map((req) => (
                <li key={req} className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
                  <span className="text-foreground/80 font-bold leading-relaxed">
                    {req}
                  </span>
                </li>
              ))}
          ...
          <div className="bg-white rounded-3xl border border-border shadow-xl p-8 sm:p-10">
            <h3 className="text-2xl font-black text-foreground mb-6 leading-tight">
              ¿No tienes diagnóstico todavía?
            </h3>
            <p className="text-foreground/70 font-semibold leading-relaxed mb-6">
              Muchas familias llegan a nosotros sin informe fonoaudiológico.{" "}
              <strong className="text-foreground">No es un obstáculo.</strong>{" "}
            ...
            <ol className="space-y-4 mb-7">
              {[
                ...
                <li key={step} className="flex items-start gap-3">
                  <span className="w-8 h-8 rounded-full bg-secondary text-primary-dark flex items-center justify-center font-black shrink-0 text-sm">
                    {index + 1}
                  </span>
                  <span className="text-foreground/80 font-bold leading-relaxed pt-0.5">
                    {step}
                  </span>
                </li>
              ))}
