...
export const metadata: Metadata = {
  title: "Matrículas 2027 Escuela de Lenguaje en Conchalí",
  description:
    "Consulta cupos 2027 en Escuela de Lenguaje Ruth, Conchalí. Evaluación fonoaudiológica gratuita, sin matrícula ni mensualidad, para niños de 3 a 5 años 11 meses.",
  alternates: {
    canonical: "/matriculas-2027-conchali",
  },
  openGraph: {
    title: "Matrículas 2027 en Escuela de Lenguaje Ruth",
    description:
      "Educación gratuita en Conchalí con evaluación fonoaudiológica sin costo y apoyo especializado para niños y niñas con TEL.",
    url: "/matriculas-2027-conchali",
  },
};

const whatsappUrl = buildWhatsAppUrl(
  "Hola, quiero consultar cupo 2027 para mi hijo(a) en Escuela de Lenguaje Ruth."
);
...
export default function MatriculasConchaliPage() {
  const breadcrumbsJsonLd = buildBreadcrumbsJsonLd([
    { name: "Inicio", url: "/" },
    { name: "Matrículas Conchalí", url: "/matriculas-2027-conchali" },
  ]);
    ...
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          <div className="max-w-3xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-secondary text-primary-dark text-xs font-black uppercase tracking-widest mb-6 shadow-xl">
              ...
              Cupos 2027 en Conchalí
            </div>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-[0.98] tracking-tight mb-7">
              Matrícula gratuita para escuela de lenguaje.
            </h1>
            <p className="text-xl sm:text-2xl text-white/90 font-bold leading-snug max-w-2xl mb-8">
              Consulta si tu hijo(a) puede postular a Escuela de Lenguaje Ruth. Atendemos niveles de Medio Mayor a Kínder con apoyo pedagógico y fonoaudiológico.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 items-center">
          <div>
            ...
            <p className="text-lg text-foreground/70 font-semibold leading-relaxed mb-8">
              Sabemos que muchas familias no tienen claro si corresponde escuela de lenguaje, qué documentos necesitan o si el diagnóstico tiene costo. Te orientamos antes de pedir cualquier trámite.
            </p>
      ...
      <section className="py-24 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-8 border-white/15">
            <Image
              src="/family-support.jpg"
              alt="Acompañamiento de familias en Escuela de Lenguaje Ruth"
              fill
          ...
          <div>
            <span className="inline-block px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white font-black uppercase tracking-widest text-xs mb-5">
              Para decidir con confianza
            </span>
            <h2 className="text-4xl sm:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Ven a conocer el ambiente, el equipo y los requisitos.
            </h2>
            <p className="text-xl text-white/85 font-semibold leading-relaxed mb-9">
              La matrícula no debería depender de trámites confusos. Te explicamos edad, jornada, documentos, evaluación y cupos disponibles antes de iniciar el proceso.
            </p>
            <Link
              href="/admision"
              className="inline-flex items-center justify-center px-8 py-5 rounded-2xl bg-secondary text-primary-dark font-black text-lg shadow-xl shadow-secondary/30 hover:scale-[1.03] transition-transform"
            >
