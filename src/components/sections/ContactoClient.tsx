...
function ContactoForm() {
  ...
  const levelPrefill = levelParam
    ? allowedLevelPrefills[levelParam]
    : undefined;
          ...
          <section className="rounded-2xl border border-border bg-surface p-6 sm:p-9">
            <div className="mb-7">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted">
                Los campos marcados como obligatorios nos permiten responderte.
                El diagnóstico previo no es necesario para escribirnos.
              </p>
            </div>
            ...
            >
              <div>
                ...
                <input
                  ...
                  aria-describedby={
                    errors.nombreApoderado ? "nombreApoderado-error" : undefined
                  }
                  {...register("nombreApoderado", {
                    required: "Escribe tu nombre para poder orientarte.",
                    maxLength: {
                      value: 100,
                      message: "Usa máximo 100 caracteres.",
                    },
                    validate: (value) =>
                      value.trim().length > 0 ||
                      "Escribe tu nombre para poder orientarte.",
                  })}
              ...
              <div>
                ...
                <input
                  ...
                  {...register("telefono", {
                    ...
                    maxLength: {
                      value: 30,
                      message: "Usa máximo 30 caracteres.",
                    },
                    pattern: {
                      value: /^[+()\d\s-]{8,30}$/,
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  {...register("mensaje")}
                  className="w-full resize-y rounded-xl border border-border bg-surface px-4 py-3 text-base font-semibold text-ink outline-none transition-colors focus:border-primary focus:bg-surface focus:ring-4 focus:ring-primary/10"
                  placeholder="Cuéntanos qué necesitas saber…"
                />
              </div>

              <div>
                <label className="flex items-start gap-3 rounded-xl border border-border bg-surface p-4 text-sm leading-relaxed text-muted">
                  <input
                    type="checkbox"
                    aria-required="true"
                    ...
                    {...register("consent", {
                      required:
                        "Necesitamos tu autorización para preparar el mensaje.",
                    })}
                    className="mt-1 h-4 w-4 shrink-0 accent-primary"
                  />
                  <span>
                    Autorizo que estos datos se incorporen en un mensaje de
                    WhatsApp para responder mi consulta. No se almacenan en
                    servidores de la escuela. Revisa la{" "}
                    <Link
                      href="/privacidad"
              ...
              <button
                type="submit"
                className="inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-base font-extrabold text-white transition-colors hover:bg-primary-dark focus-visible:ring-4 focus-visible:ring-primary/20"
              >
